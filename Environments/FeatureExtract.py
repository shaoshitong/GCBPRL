...
class FE:
    ...
    def __call__(self, obs,reward,done,choose):
        ...
        new_obs_3 = torch.from_numpy(np.concatenate([new_obs_3_1,new_obs_3_2],0)).float() # TODO: (queue_number * 2, 2 )
        ...
        choose_action_1, choose_action_2 = torch.from_numpy(choose[0]).float(), torch.from_numpy(choose[1]).float()
        return [new_obs_1,new_obs_2,new_obs_3,new_obs_time_1,new_obs_time_2,new_obs_time_3],reward,done,[choose_action_1,choose_action_2]
